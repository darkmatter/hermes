...
## Prefer feed HITL for Cooper

For **Cooper / Hermes day-to-day decisions** (pay, approve, pick, confirm), use the production feed surface — skill **`feed-decisions`**:

- Create: `bun ~/git/darkmatter/feed/scripts/hitl.ts ask …`
- UI: https://feed.cm.xyz → **Needs your decision**
- Do not invent a new form service unless feed HITL cannot express the type

This skill remains the contract for **building standalone typed queues** (other products, non-Cooper humans, custom embeds).
