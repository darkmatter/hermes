...
const COLORS: { name: string; token: string; value: string; border?: boolean }[] = [
  { name: "Background", token: "<REDACTED>", value: "var(--background)", border: true },
  { name: "Card", token: "<REDACTED>", value: "var(--card)", border: true },
  { name: "Muted", token: "<REDACTED>", value: "var(--muted)" },
  { name: "Primary", token: "<REDACTED>", value: "var(--primary)" },
  { name: "Brand", token: "<REDACTED>", value: "var(--brand)" },
  { name: "Teal glow", token: "<REDACTED>", value: "var(--glow-teal)" },
  { name: "Diff added", token: "<REDACTED>", value: "var(--diff-added)" },
  { name: "Diff removed", token: "<REDACTED>", value: "var(--diff-removed)" },
  { name: "Success", token: "<REDACTED>", value: "var(--success)" },
  { name: "Warning", token: "<REDACTED>", value: "var(--warning)" },
  { name: "Destructive", token: "<REDACTED>", value: "var(--destructive)" },
  { name: "Border", token: "<REDACTED>", value: "var(--border)" },
];

const TYPE: { label: string; token: string; size: string; mono?: boolean }[] = [
  { label: "Hero", token: "<REDACTED>", size: "var(--text-6xl)" },
  { label: "Title", token: "<REDACTED>", size: "var(--text-2xl)" },
  { label: "Body", token: "<REDACTED>", size: "var(--text-sm)" },
  { label: "darwin-rebuild switch", token: "<REDACTED>", size: "var(--text-sm)", mono: true },
];

const RADII: { label: string; token: string; value: string }[] = [
  { label: "sm · inputs", token: "<REDACTED>", value: "var(--radius-sm)" },
  { label: "md · buttons", token: "<REDACTED>", value: "var(--radius-md)" },
  { label: "lg · cards", token: "<REDACTED>", value: "var(--radius-lg)" },
  { label: "xl · panels", token: "<REDACTED>", value: "var(--radius-xl)" },
];
