...
Write repo-relative paths (`skills/...`, `tools/skill_manager_tool.py`). A `~/...` path baked into a committed skill breaks for every other user and is an instant review flag.
