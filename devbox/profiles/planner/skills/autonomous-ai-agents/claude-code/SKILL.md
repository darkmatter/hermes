...
2. **Local project:** `.claude/<REDACTED>.json` (personal, gitignored)
...
3. **Local:** `.claude/<REDACTED>.md` — personal project overrides (gitignored)
...
| `-s local` | This project (personal) | `.claude/<REDACTED>.json` (gitignored) |
